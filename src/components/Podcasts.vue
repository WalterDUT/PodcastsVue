        ...
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            <h2 class="text-white font-weight-light mb-2 display-4">
              Episode 09: How To Create Web Page Using Bootstrap 4
            </h2>
    ...
    <div class="site-section bg-light">
      <div class="container">
        ...
        >
          <div
            class="image"
            :style="{ 'background-image': 'url(' + randomPic() + ')' }"
          ></div>
          <div class="text">
          ...
          <div class="col-md-12 text-center">
            <div class="site-block-27">
              <ul class="text-center">
                <li>
                  <a @click.prevent="prevPage" v-if="first === false" href="#"
                    >&lt;</a
                  >
                </li>

                <li>
                  <a @click.prevent="nextPage" v-if="last === false" href="#"
                    >&gt;</a
                  >
                </li>
              </ul>
